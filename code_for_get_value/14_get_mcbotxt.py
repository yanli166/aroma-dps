...
csv_filename = r"/home/ubuntu/cal/DPSCAL/merged-out.csv"
fchk_directory = r'/home/ubuntu/cal/DPSCAL/fchk'  # fchk文件所在的目录
output_directory = r'/home/ubuntu/cal/DPSCAL/mbcotxt'  # 指定输出目录
txt_prefix = 'mbco-'  # TXT文件名前缀
