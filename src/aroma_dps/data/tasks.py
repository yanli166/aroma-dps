...
from aroma_dps.config import COLLET_DIR

# 训练集目录: publication 布局下的 data/collet (可用 DATA1_END_DIR 指向外部工作目录)
DATA1_END_DIR = os.environ.get('DATA1_END_DIR', COLLET_DIR)
